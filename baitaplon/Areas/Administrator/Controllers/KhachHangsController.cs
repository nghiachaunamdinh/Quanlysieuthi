...
namespace baitaplon.Areas.Administrator.Controllers
{
    public class KhachHangsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaKH,Ten,DiaChi,DienThoai,NgayCapThe,NgayMuaGanNhat,DiemThuong")] KhachHang khachHang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaKH,Ten,DiaChi,DienThoai,NgayCapThe,NgayMuaGanNhat,DiemThuong")] KhachHang khachHang)
        {
            if (ModelState.IsValid)
            {
